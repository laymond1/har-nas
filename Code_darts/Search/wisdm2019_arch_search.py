...
from models import WISDM19RunConfig
...
parser.add_argument('--path', type=str, default='./logs/wisdm2019/warmp100_gr')
...
parser.add_argument('--dataset', type=str, default='wisdm2019', choices=['wisdm2019'])
