...
class WISDMDataProvider(DataProvider):
    ...
    def save_path(self):
        if self._save_path is None:
            self._save_path = './dataset/wisdm'
        return self._save_path

    @property
    def data_url(self):
        raise ValueError('unable to download WISDM')
