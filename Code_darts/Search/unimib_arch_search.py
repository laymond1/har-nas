...
from models import UniMiBRunConfig
...
parser.add_argument('--path', type=str, default='./logs/unimib')
...
parser.add_argument('--dataset', type=str, default='unimib', choices=['ucihar', 'wisdm2019', 'unimib'])
