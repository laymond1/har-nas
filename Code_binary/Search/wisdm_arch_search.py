...
from models import WISDMRunConfig
...
parser.add_argument('--path', type=str, default='./logs/wisdm')
...
parser.add_argument('--dataset', type=str, default='wisdm', choices=['ucihar', 'wisdm'])
